...
import com.silvermatch.someutilities.event.SomeUtilitiesEventHandler;
...
import com.silvermatch.someutilities.world.gen.WorldGeneratorFlag;
...
public class SomeUtilities{
    ...
    public void preInit(FMLPreInitializationEvent event){
        ...
        MinecraftForge.EVENT_BUS.register(new SomeUtilitiesEventHandler());//For registering events from the net.miencraftforge.event package.
        FMLCommonHandler.instance().bus().register(new SomeUtilitiesEventHandler());//For registering events from the cpw.mods.fml.gameevent package.
